...
public interface UserService {
	...
	User getUserByUserId(String userId);//根据用户Id获取用户
	List<User> getAllUsers();//获取所有用户
	
	void updateUserRoles(String userId,String...roleIds);//修改用户角色关联
	
	Set<String> findRolesByUserId(String userId);//根据用户Id获取用户所有角色
	Set<String> findJurisdictionsByUserId(String userId);//根据用户Id获取用户所有权限
